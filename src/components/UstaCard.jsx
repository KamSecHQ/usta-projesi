function UstaCard({ initials, name, role, desc, tags, onayli }) {
    ...
    return (
        <div className="bg-white/[0.03] backdrop-blur-md border border-white/[0.08] rounded-2xl p-6 relative hover:border-[#C97D3C]/40 hover:bg-white/[0.05] transition-all duration-300">
            ...
            <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#C97D3C] to-[#E3B776] flex items-center justify-center text-[#0D2626] font-bold shrink-0">
                    {initials}
                </div>
                <div>
